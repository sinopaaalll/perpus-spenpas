                        ...
                        <div class="card-body">
                            <form action="<?= base_url('anggota/edit/' . $anggota->id) ?>" method="post">
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-6">
                                        <input type="text" name="name" id="name" class="form-control <?= form_error('name') ? "is-invalid" : "" ?>" placeholder="Nama Lengkap" value="<?= $anggota->name ?>">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-6">
                                        <input type="number" name="nisn" id="nisn" class="form-control <?= form_error('nisn') ? "is-invalid" : "" ?>" placeholder="NISN" value="<?= $anggota->nisn ?>">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-6">
                                        <input type="date" name="tgl_lahir" id="tgl_lahir" class="form-control <?= form_error('tgl_lahir') ? "is-invalid" : "" ?>" placeholder="Tanggal Lahir" value="<?= $anggota->tgl_lahir ?>">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="jk" id="jk1" value="0" <?= $anggota->jk == 0 ? "checked" : "" ?>>
                                            <label class="form-check-label" for="jk1"> Laki-laki </label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="jk" id="jk2" value="1" <?= $anggota->jk == 1 ? "checked" : "" ?>>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-6">
                                        <input type="number" name="telp" id="telp" class="form-control" placeholder="Telepon" value="<?= $anggota->telp ?>">
