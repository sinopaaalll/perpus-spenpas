                                ...
                                <div class="form-group">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-4 col-md-4">
                                            <img id="preview" src="<?= base_url('assets/images/cover-undefined.png') ?>" alt="Preview Sampul" class="img-thumbnail" style="width:100%; height:auto; object-fit:cover; aspect-ratio: 3/4;">
                                        </div>
                                        ...
                                        <div class="col-lg-8 col-md-8">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="isbn" class="form-control <?= form_error('isbn') ? "is-invalid" : "" ?>" placeholder="ISBN : ex 978-602-8519-93-9" value="<?= set_value('isbn') ?>">
                                                <?= form_error('isbn', '<div class="invalid-feedback">', '</div>') ?>
                                            </div>
                                            <div class="form-group">
                                                <label class="form-label">Judul*</label>
                                                <input type="text" name="judul" class="form-control <?= form_error('judul') ? "is-invalid" : "" ?>" placeholder="Judul" value="<?= set_value('judul') ?>">
                                            ...
                                            <div class="form-group mt-3">
                                                <div class="row">
                                                    <div class="col-6">
                                                        ...
                                                        <input type="text" name="penulis" class="form-control <?= form_error('penulis') ? "is-invalid" : "" ?>" placeholder="Penulis" value="<?= set_value('penulis') ?>">
                                                        <?= form_error('penulis', '<div class="invalid-feedback">', '</div>') ?>
                                                    </div>
                                                    <div class="col-6">
                                                        <label class="form-label">Penerbit*</label>
                                                        <input type="text" name="penerbit" class="form-control <?= form_error('penerbit') ? "is-invalid" : "" ?>" placeholder="Penerbit" value="<?= set_value('penerbit') ?>">
                                            ...
                                            <div class="form-group mt-3">
                                                <div class="row">
                                                    <div class="col-4">
                                                        ...
                                                        <input type="number" name="tahun_terbit" class="form-control <?= form_error('tahun_terbit') ? "is-invalid" : "" ?>" placeholder="Tahun Terbit" value="<?= set_value('tahun_terbit') ?>" min="1900" max="2100">
                                                        <?= form_error('tahun_terbit', '<div class="invalid-feedback">', '</div>') ?>
                                                    </div>

                                                    <div class="col-2">
                                                        <label class="form-label">Stok*</label>
                                                        <input type="number" name="stok" class="form-control <?= form_error('stok') ? "is-invalid" : "" ?>" placeholder="Stok" value="<?= set_value('stok') ?>">
